        ...
        for (int y = 0; y < 4; y++) {
            for (int z = 0; z < 4; z++) {
                if (getBit(model, x, y, z)) { // if voxel at x, y, z is on
                    ...
                    if (x + 1 > 3 || !getBit(model, x + 1, y, z)) { // if off or outside of range PX
                    ...
                    if (y + 1 > 3 || !getBit(model, x, y + 1, z)) { // if off or outside of range PY
                    ...
                    if (z + 1 > 3 || !getBit(model, x, y, z + 1)) { // if off or outside of range PZ
